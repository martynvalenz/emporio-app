      ...
      <q-card class="q-mt-md">
         <q-card-section>
            <div class="row">
               ...
               <q-btn label="Recibo" icon-right="receipt" color="blue-10" class="q-mx-xs" @click="addBill" />
               <q-space />
   ...
   components:{Customer, Service, Bill, InfiniteLoading},
	...
	methods:{
      ...
      storeCustomer(data){
		...
		addBill(){
			this.$refs.bills_form.addBillAlready('', '', 'Recibo', 2);
		},
